                    ...
                    <div className="  d-flex flex-wrap flex-md-nowrap align-items-center  justify-content-end">
                        ...
                        <div className=" container  p-3">
                            ...
                            <div className="py-2 display-1 text-dark d-md-block text-center ">
                                <p style={{color:"#07393C"}} className=" display-3   "><strong>MEET OUR TEAM</strong></p>
                                <p style={{color:"#07393C"}} className="display-3 ">We Welcome You In Warm And Relaxed Atmosphere </p>
