    ...
    return (
        ...
        <tr style={{ backgroundColor: appointments.status ? "#80de95" : "#e9949c" }}  >
            ...
            <td>
                ...
                <a type="button" onClick={handleShow} className="btn btn-floating btn-info my-1 btn-md"><i class="far fa-edit"></i></a>
            </td>
            ...
            <>
                ...
                >
                    ...
                    <Modal.Footer>
                        ...
                        <Button variant="secondary" onClick={handelUpdate}>SAVE CHANGES</Button>
                    </Modal.Footer>
                </Modal>
            </>
        </tr>
