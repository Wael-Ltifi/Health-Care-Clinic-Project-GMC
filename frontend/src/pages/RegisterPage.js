                    ...
                    <Slide right >
                        <div style={{ border: "1px solid gray", borderRadius: "15px", backdropFilter: "blur(6px)" }} className="  mx-md-5 p-md-2">
                            <form className="px-md-5  py-3" onSubmit={handelSubmit}>
                                ...
                                <div className="  py-3">
                                    <button type="submit" className="btn mx-sm-5 text-light  btn-warning">Sign UP</button>
                            ...
                            <div>
                                ...
                                <a className="text-decoration-none m-sm-5 p-sm-3 text-light" >you already have an account ? <Link className=" text-decoration-none text-light " to='/login'><strong>Login</strong></Link></a>
