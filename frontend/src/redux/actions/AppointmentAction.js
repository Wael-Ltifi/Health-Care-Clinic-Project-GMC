...
export const addAppointment = (date) => async dispatch => {
    ...
    try {
        setToken()
        const res = await axios.post('/api/appointment/add', date)
        dispatch({
...
export const getAllAppointment = () => async dispatch => {
    ...
    try {
        setToken()
        const res = await axios.get('/api/appointment/allAppointment',)
        dispatch({
...
export const deleteApp = (id) => async (dispatch) => {
    ...
    try {
        setToken()
        const res = await axios.delete(`/api/appointment/deleteAppointment/${id}`)
        dispatch({
...
export const updateApp = (id, updatedDate) => async (dispatch) => {
    ...
    try {
        setToken()
        const res = await axios.put(`/api/appointment/updateAppointment/${id}`, updatedDate)
        dispatch({
...
export const getAppointment = () => async (dispatch) => {
    ...
    try {
        setToken()
        const res = await axios.get('/api/appointment/getApp')
        dispatch({
